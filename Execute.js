// imports from Traversing.js

import {
  sumOfArrayElements,
  sumOfArrayElementsUsingReduce,
  findOccurence,
  maxAndMinFromArr,
  maxAndMinFromArrReduce,
  maxAndMinFromLoop,
  reverseArrayInplace,
  findAverage,
...
import {
  findTheIndexOfElement,
  findElementIndexUsingBinarySearch,
  findFirstIndexUsingBinarySearch,
...
// console.log(searchElementInRotatedSortedArray([5, 6, 7, 1, 2, 3, 4], 6));
